...
func OpenAiQuery(uid string, msg string, timeout time.Duration) (reply string) {
	...
	if length > globalConfig.OpenAI.MaxQuestionLength {
...
func postApi(msg string) (io.ReadCloser, error) {
	...
	req, _ := http.NewRequest("POST", globalConfig.OpenAI.Params.Api, bytes.NewReader(bs))
	req.Header.Add("Content-Type", "application/json")
	req.Header.Add("Authorization", "Bearer "+globalConfig.OpenAI.Key)
